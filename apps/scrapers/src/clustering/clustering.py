...
from src.clustering.labeling import run_cluster_labeling_job
...
def run_clustering_job():
    ...
    for idx, label in enumerate(labels):
        ...
        if label == -1:
            # -1 signifies noise outliers: isolate them from any group cluster
    ...
    # 6. Immediately execute structural labeling and entropy processing
