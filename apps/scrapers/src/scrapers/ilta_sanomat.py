"""Scraper for Ilta-Sanomat.

Ilta-Sanomat is a Finnish tabloid, owned by Sanoma. Center-right.
"""
...
class IltaSanomatScraper(BaseScraper):
    ...
    def parse_entry(self, entry: feedparser.FeedParserDict) -> ScrapedArticle | None:
        ...
        article_type = "news"
        if "/paakirjoitus/" in url or "/mielipide/" in url:
