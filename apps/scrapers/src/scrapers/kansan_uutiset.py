...
Left-wing newspaper affiliated with the Left Alliance (Vasemmistoliitto).
Bias classification: -2 (party-organ tier, left).

Domain note: kansanuutiset.fi redirects to ku.fi; canonical feed is at
https://www.ku.fi/feed (no trailing slash).
"""
...
class KansanUutisetScraper(BaseScraper):
